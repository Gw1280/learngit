...
var GlobalMin=0;
	...
	//ajax
		function aj() {
			var aj = $.ajax( {    
    url:'http://'+comServerIP+'/Web/ExamFileInfo/00000101',
    ...
    error: function(XMLHttpRequest, textStatus, errorThrown) {
		...
		function aj1(FilePath) {
			var aj1 = $.ajax( {    
			    url:'http://'+comServerIP+'/Web/DATFileInfo',
				headers:{"Authorization":$.cookie('Authorization2')},	
				//headers: {"Authorization" : "lucy,0000004800000001"},
			    type:'post',    
...
//	if ( range < 0.00001 ) return -1;//�������Ϊ��ɫ��ʱ�򣬸��µ��Ƴ�ʱ�в�������
 ...
 function draw16(id, RGBData) {
             ...
             //image.onload = function () {
                 ...
                 //����ȡ���������ǿհ׵�canvas������
				 var imagedata = context.createImageData(TWidth, THeight);
